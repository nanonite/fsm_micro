...
#define  DEBUGG		//Uncomment to turn on debug
...
//FULL FUNC DESCRIPTION IN SOURCE
	...
	////////////////////////////INIT FUNC
	virtual bool init(uint16_t = 100);		//INITS, CALLS BASE INIT defaults to autobaud.
	...
	//AT+CGPADDR reads Current IP
	const char* const checkipCGPADDR(const char*const _context);
	...
	////////////////////////////////////////////////////////////////////////////////SOCKET CONTROL
	//FRWL AT#FRWL  Mode 0-> remove 1 ->ADD 2-> drop all
	bool firewallFRWL(const char* const mode, 
	...
	const char* const socketStatusSS(const char*); 	// returns status of a socket.
	const char* const socketInfoSI(const char* const); //socket info
	bool socketConSCFGEXT(const char* const socketid,const char* const srMode="0",
	const char* const recDataMode="0",const char* const alive = "0",
	const char* const autoRes ="0",const char* const sendDataMode ="0");
